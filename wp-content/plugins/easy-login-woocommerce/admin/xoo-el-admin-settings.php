...
class Xoo_El_Admin_Settings{
	...
	public function menu_page_callback(){
		...
		wc_get_template("xoo-el-admin-display.php",$args,'',XOO_EL_PATH.'/admin/templates/');
	}


	/*public function get_all_settings(){
		$settings = array();
		$settings[] = include XOO_EL_PATH.'admin/includes/settings/class-xoo-el-general-settings.php';
		return $settings;
	}*/
